...
const Traits = () => {
  ...
  const assetsPage = <Link leavesPage={false} text="assets page" url="/assets" />;
    ...
    <>
      <PageHeader>
        ...
        <Subheader
          ...
          body={
            <>
              All the individual traits sized up to 500 x 500px for your convenience. If you need
              other downloads check out the {assetsPage}.
            </>
          }
        />
      ...
      <PageContent>
        <div className="bg-grey-base py-6 xs:px-1 sm:px-4 rounded-xl mb-8">
          <h1 id="heads" className="text-5xl text-nouns mb-6 text-center text-black">
            Heads
          </h1>
        ...
        <div className="bg-grey-base py-6 xs:px-1 sm:px-4 rounded-xl  mb-8">
          <h1 id="glasses" className="text-5xl text-nouns mb-6 text-center text-black">
            Glasses
          </h1>
          <div className="grid xs:grid-cols-4 sm:grid-cols-5 lg:grid-cols-6 xl:grid-cols-6 gap-2 ">
            {glasses &&
        ...
        <div className="bg-grey-base py-6 xs:px-1 sm:px-4 rounded-xl  mb-8">
          <h1 id="bodies" className="text-5xl text-nouns mb-6 text-center text-black">
            Bodies
          </h1>
          <div className="grid xs:grid-cols-4 sm:grid-cols-5 lg:grid-cols-6 xl:grid-cols-6 gap-2 ">
            {bodies &&
        ...
        <div className="bg-grey-base py-6 xs:px-1 sm:px-4 rounded-xl  mb-8">
          <h1 id="accessories" className="text-5xl text-nouns mb-6 text-center text-black">
            Accessories
          </h1>
          <div className="grid xs:grid-cols-4 sm:grid-cols-5 lg:grid-cols-6 xl:grid-cols-6 gap-2 ">
            {accessories &&
